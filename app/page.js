  ...
  return (
    <main className="flex flex-col justify-center bg-yellow-50 text-black min-h-screen itehms-center">
      <div className="flex flex-col justify-center items-center gap-2">
        <h1 className="text-7xl font-bold text-center p-2">Welcome to PantryPie</h1>
        <h2 className="text-xl font-semibold">
          Never Worry What's in Your Pantry Again!
        </h2>
      ...
      <div className="flex flex-col items-center pt-6">
        ...
        <Link href="/sign-in" passHref>
         <button className="text-sm hover:scale-110 font-sans hover:font-bold">Sign In</button>
        </Link>
      </div>
    </main>
  );
